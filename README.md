...
3.  ที่กลุ่มเราเลือก RMSE แทน MSE เพราะว่า ด้วย Target price ซึ่งหน่วยเป็น ปอนด์ เลยใช้ RMSE เพื่อไม่ต้องยกกำลังสอง อ่านจะอ่านผลได้ง่ายกว่าครับ


นี่คือเหตุผล 3 ข้อที่คุณต้องตอบอาจารย์ครับ:

1. เรื่องของ "หน่วย" (Unit mismatch) 📏
Target ของเรา: ราคารถ มีหน่วยเป็น ปอนด์ (£)

MSE: เอาค่า error มายกกำลังสอง หน่วยจึงกลายเป็น ปอนด์กำลังสอง (£²)

ความรู้สึก: เหมือนคุณถามราคาไข่ไก่ แล้วแม่ค้าบอกว่า "ราคา 50 บาทกำลังสอง" ... งงไหมครับ? งงแน่นอน

RMSE: เราถอด Root เพื่อให้หน่วยกลับมาเป็น ปอนด์ (£) เหมือนเดิม

ความรู้สึก: แม่ค้าบอก "ราคาบวกลบไม่เกิน 50 บาท" ... อันนี้เข้าใจทันที
